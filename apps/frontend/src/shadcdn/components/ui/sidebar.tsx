  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(2)))] lg:peer-data-[variant=inset]:m-22 lg:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-22 lg:peer-data-[variant=inset]:ml-0 lg:peer-data-[variant=inset]:rounded-xl lg:peer-data-[variant=inset]:shadow",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn(
        "mx-2 w-auto bg-sidebar-border border-input border shadow-sm",
        className,
      )}
      {...props}
    />
